...
async def ask_amount(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cancel_keyboard = InlineKeyboardMarkup(
        [[InlineKeyboardButton("🔙 Bekor qilish", callback_data="cancel_amount")]]
    )
    await query.edit_message_text(
...
async def cancel_amount_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            TYPING_AMOUNT: [
                ...
                CallbackQueryHandler(cancel_amount_button, pattern="^cancel_amount$"),
            ],
        },
